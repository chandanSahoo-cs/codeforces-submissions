...
# Save Codechef submissions to a folder
...
def main():
    username = 'realm'  # Replace with your Codechef username
    solutions = list(get_solutions(username))
    save_submissions(solutions, 'codechef_submissions')  # Save in a folder
